...
export async function GET(_request: Request, { params }: RouteParams) {
  ...
  const data: InvoicePdfData = {
    ...
    business: {
      ...
      swiftBicCode: businessProfile.swiftBicCode,
      lutNumber: businessProfile.lutNumber,
      lutDate: businessProfile.lutDate ? toDateOnly(businessProfile.lutDate) : null,
      pdfShowQuantity: businessProfile.pdfShowQuantity,
      pdfShowUnitPrice: businessProfile.pdfShowUnitPrice,
      pdfShowDiscount: businessProfile.pdfShowDiscount,
      pdfShowTax: businessProfile.pdfShowTax,
      pdfShowSacCode: businessProfile.pdfShowSacCode,
