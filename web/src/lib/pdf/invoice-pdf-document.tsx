...
const styles = StyleSheet.create({
  ...
  summaryPaymentRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 3, marginTop: 6 },
      ...
      <Page size="A4" style={styles.page}>
        <View style={styles.row}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            ...
            {data.dueDate && <Text style={styles.muted}>Due: {data.dueDate}</Text>}
        ...
        <View style={styles.summary}>
          ...
          <View style={styles.summaryPaymentRow}>
            ...
            <Text style={{ fontWeight: 700 }}>{data.remainingAmount}</Text>
          </View>
        </View>
